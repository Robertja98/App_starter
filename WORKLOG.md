...
- Added technician-focused history APIs and validation coverage: [ServiceVisitController.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Controllers/ServiceVisitController.php) now exposes `GET /api/visits/recent`, [SiteController.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Controllers/SiteController.php) now exposes `GET /api/sites/{id}/history`, [ServiceVisit.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Models/ServiceVisit.php) now provides recent-by-technician and site aggregate metric queries, and [public/index.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/public/index.php) routes both endpoints. [backend_smoke.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/tests/backend_smoke.php) now asserts recent technician visits and site history metrics include the synced visit fixture.

- Hardened sync and field-write safety across [app/Controllers/SyncController.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Controllers/SyncController.php), [app/Controllers/MeasurementController.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Controllers/MeasurementController.php), and [app/Controllers/ConsumableController.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Controllers/ConsumableController.php): session-auth sync now enforces CSRF, offline flag no longer bypasses CSRF on direct writes, broken measurement/consumable list SQL now matches the live schema, and sync-created measurements/consumables/media now use per-entity idempotency keys plus audit logging parity. Added [004_sync_idempotency_keys.sql](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/database/migrations/004_sync_idempotency_keys.sql), model support in [Measurement.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Models/Measurement.php), [Consumable.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Models/Consumable.php), [MediaItem.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/Models/MediaItem.php), and extended [backend_smoke.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/tests/backend_smoke.php) with session sync CSRF, measurement/consumable idempotency, and corresponding audit assertions.
...
- Moved session cookie naming behind config in [app/bootstrap.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/app/bootstrap.php) and [config/app.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/config/app.php), updated [backend_smoke.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/tests/backend_smoke.php) to read the configured session cookie name, and expanded [bootstrap-starter.ps1](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/bootstrap-starter.ps1) so it can rename the remaining template-facing branding in config defaults, the app shell, the web manifest, dev-server prompts, and local testing guide examples.
- Replaced the out-of-the-box runtime branding defaults with neutral starter values in [config/app.php](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/config/app.php), [public/app.html](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/public/app.html), and [public/manifest.json](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/public/manifest.json), then updated [bootstrap-starter.ps1](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/bootstrap-starter.ps1) to rename those new generic defaults cleanly for derived apps.
- Made the local development defaults generic too by switching the default database name to `app_local_dev`, renaming the setup helper's temporary environment variable, and updating [dev-server.ps1](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/dev-server.ps1), [dev-server.sh](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/dev-server.sh), and [LOCAL_TESTING_GUIDE.md](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/LOCAL_TESTING_GUIDE.md) to reference the neutral starter baseline instead of the old service-specific defaults.
- Added a top-level `Start A New App` section to [README.md](C:/Users/rober/OneDrive/0.5-Eclipse/Service%20App/README.md) so the GitHub landing page now shows the starter bootstrap workflow immediately instead of requiring readers to scroll into the longer setup guide.
