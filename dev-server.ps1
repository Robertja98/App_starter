...
Write-Host "PHP MySQL PWA Starter - Dev Server" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "Before starting, ensure:" -ForegroundColor Yellow
Write-Host "  1. Local MySQL is running"
Write-Host "  2. Database created: CREATE DATABASE app_local_dev;"
Write-Host "  3. Schema imported: mysql -u root app_local_dev < database/migrations/001_initial_schema.sql"
Write-Host ""
